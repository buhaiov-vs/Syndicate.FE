...
import { Symbols, ValidationRules } from '@/lib/consts';
...
export const TagsInput = ({ control, title, className, maxTagsCount = 10, tagMaxLength = 25, tagMinLength = 1 }: TagsInputProps<any>) => {
  ...
  return (
    <>
    <div className={"flex flex-col border border-creamAccent rounded-md flyable " + className + (flying ? " flying" : "")}>
